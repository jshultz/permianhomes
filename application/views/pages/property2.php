...
<p class="postInfo">
              <!-- <span class="postInfoAuthor">Author Name</span> -->
                ...
                <?php if ( count($location_photos) == 0 ): ?>
                    <div itemprop="image" class="image">No photo!</div>
                <?php elseif ( count($location_photos) == 1): 
                            $photo = current($location_photos);
                    ?>
                 <div itemprop="image" class="image">
                      <img width="566px"  src="<?php echo $photo['fullsize']; ?>">
                      <?php
                      if ($row->reduced == '1') {
                ...
                <?php else: ?>
                  <div id="featureHolder" class="property-slideshow"> <!-- begin: featureHolder -->
                    <div id="featureMask">
                        <div id="featureSlide">
                            <div class="scrollable" id="scrollable">
                                <div class="items">
                                    <?php foreach($location_photos as $photo): ?>
                                        <img width="566px" src="<?=$photo['thumb'];?>">
                                    <?php endforeach; ?>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="slideshow-spacer clear" ></div>
                <?php endif; ?>              
