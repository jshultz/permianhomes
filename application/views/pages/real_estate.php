...
<div class="">
    <div id="tabwrap" class="clearfix">
        <ul class="tabs clearfix">
            ...
            <li><a class="midland" href="#">Midland</a></li>
        </ul>
	        ...
	        <div id="tabs-2" class="pane">
		        ...
		        <section class="clearfix" style="width: 100%; display: block">
			        ...
			        <div class="floatright clearfix">
				        <a class=" button" href="/assets/pdfs/OldCourseEstatesSite.pdf" target="_blank">
        ...
        <div id="midland" class="pane">
            ...
            <div id="tabs-4" class="pane ">
                ...
                <p><strong>New Single Family Homes from the $180's</strong></p>
