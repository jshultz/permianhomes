		...
		else
		{
			switch ($config)
			{
				case 'comment':
					...
					$config->set('HTML.Allowed', 'p,a[href|title],abbr[title],acronym[title],b,strong,blockquote[cite],code,em,i,strike,img');
                    $config->set('HTML.AllowedElements', array('img', 'a', 'b', 'strong', 'i', 'em', 'u', 'span', 'div', 'br', 'p', 'hr', 'style'));
