<?php
  ...
  if ( is_array($UT_custom_theme_option) ) {
		if ($show_thumb_pos == 'right') {
			$cat_id = $UT_custom_theme_option[UT_THEME_SHORT_NAME . '_sidebar_cat6'];
			$num_cat_post = $UT_custom_theme_option[UT_THEME_SHORT_NAME .'_sidebar_cat6_numposts'];
    } else {
			$cat_id = $UT_custom_theme_option[UT_THEME_SHORT_NAME . '_sidebar_cat4'];
			$num_cat_post = $UT_custom_theme_option[UT_THEME_SHORT_NAME .'_sidebar_cat4_numposts'];
    }
      ...
      <h1> <?php
       ...
       <div class="subcontainer"> <?php
         while ($the_query->have_posts()) :
           $the_query->the_post();
           ?>
           <span class="<?php echo $class_name; ?>  thumb_a">
           ...
           <span class="thumb_detail">
             ...
             echo utility_trim_words(get_the_excerpt(),15); ?></em>
           </span>
